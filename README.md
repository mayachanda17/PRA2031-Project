...
Student Budget Planner is a Python application that helps students estimate and organize their monthly expenses in Maastricht. It combines personal health calculations, budgeting logic, student-related academic costs, and visualisations in one command-line application.
...
- Visual summaries of budget data using graphs
...
## Data source
The file `average_costs.txt` contains estimated average monthly costs for students in Maastricht and is used to initialise default budgeting values.
...
Example of budget visualisation generated by the program:
<img width="640" height="480" alt="Figure_1" src="https://github.com/user-attachments/assets/099580d5-62eb-4f3f-8987-ccab11207b86" />
...
- Maya Chanda: Main program structure, README documentation, debugging
- Szonja Szekeres: Student class and academic cost calculations
- Szymon Stembalski: Budget logic and financial calculations
- Maya Eden: Priority calculations and visualisation functions
- Mila Croci: Testing, debugging, and documentation review
